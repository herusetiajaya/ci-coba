...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Congratulation! your account has been created. Please activate your account <a href="' . base_url() . 'auth/pageactivation?email=' . $this->input->post('email') . '&token=' . urlencode($token) . '">here</a> </div>');
            redirect('auth');
        }
    }
    ...
    public function pageactivation()
    {
        ...
        $this->load->view('templates/auth_header', $data);
        $this->load->view('auth/pageactivation', $data);
        $this->load->view('templates/auth_footer');
    }
    ...
    public function forgotpassword()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            if ($user) {
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Please check your email to reset your password! <a href="' . base_url() . 'auth/pageresetpass?email=' . $this->input->post('email') . '&token=' . urlencode($token) . '">here</a></div>');
    ...
    public function pageresetpass()
    {
        ...
        $this->load->view('templates/auth_header', $data);
        $this->load->view('auth/pageresetpass', $data);
        $this->load->view('templates/auth_footer');
    }
