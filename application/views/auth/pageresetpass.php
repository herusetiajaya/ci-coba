                        ...
                        <div class="card-body text-lg-left">
                            ...
                            <div class="row">
                                ...
                                <div>
                                    ...
                                    <h5 class="card-subtitle mb-2 text-muted">: <?= $token; ?></h5>
                                    <p class="lead text-gray-800 mb-1 font-weight-bold">: Click this link to reset password</p>
                                    <p class="lead text-gray-800 mb-1 font-italic"><a href="<?= base_url('auth/resetPassword?email='); ?><?= $emailTo; ?>&token=<?= urlencode($token); ?> ">&raquo reset password here &laquo</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
